...
class MySQLDataType(StandardDataType):
    # Integer types
    TINYINT = SQLDataType(name="TINYINT", category=DataTypeCategory.INTEGER, alias=["TINY"], has_unsigned=True)
    SMALLINT = SQLDataType(name="SMALLINT", category=DataTypeCategory.INTEGER, alias=["SHORT"], has_unsigned=True)
    MEDIUMINT = SQLDataType(name="MEDIUMINT", category=DataTypeCategory.INTEGER, alias=["INT24"], has_unsigned=True)
    INT = SQLDataType(name="INT", category=DataTypeCategory.INTEGER, alias=["INTEGER", "LONG"], has_unsigned=True)
    BIGINT = SQLDataType(name="BIGINT", category=DataTypeCategory.INTEGER, alias=["LONGLONG"], has_unsigned=True)
    ...
    TINYBLOB = SQLDataType(name="TINYBLOB", category=DataTypeCategory.BINARY, alias=["TINY_BLOB"])
    BLOB = SQLDataType(name="BLOB", category=DataTypeCategory.BINARY)
    MEDIUMBLOB = SQLDataType(name="MEDIUMBLOB", category=DataTypeCategory.BINARY, alias=["MEDIUM_BLOB"])
