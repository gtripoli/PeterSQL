...
@patch('wx.GetApp')
@patch('windows.main.table.column.CURRENT_SESSION')
@patch('windows.main.table.column.CURRENT_TABLE')
@patch('windows.main.table.column.NEW_TABLE')
...
@patch('windows.main.table.column.CURRENT_SESSION')
@patch('windows.main.table.column.CURRENT_TABLE')
@patch('windows.main.table.column.CURRENT_COLUMN')
@patch('windows.main.table.column.NEW_TABLE')
